...
echo $ white " [#]> Team Army Cyber hadir ... "
...
echo $green"kontak admin:62895-3635-*****"

echo $Orange"Autohor: RianWk"

echo $Red"Thanks To Team Army Cyber"
...
echo $green"Author RianWk"

echo $green"Jika Ada masalah Hubungi Nomer Saya "

echo $green"kontak admin:6289-6982-70794"

echo $green"ThanksTo; sampai jumpa"

echo $green"ThanksTo; terimakasih"

echo $green"ThanksTo; anggota TAC"

echo $green"ThanksTo; Mrruxhan"

echo $red"TEAM ARMY CYBER"
